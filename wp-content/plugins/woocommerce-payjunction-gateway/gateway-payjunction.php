...
Description: The PayJunction payment gateway plugin for WooCommerce. A PayJunction account, Curl support, and a server with SSL support and an SSL certificate is required (for security reasons) for this gateway to function. <a href="https://pricing.payjunction.com/" target="_blank">Click Here</a> to get a PayJunction account.
Version: 2.0
Author: PayJunction
...
function woocommerce_payjunction_init() {
	...
	class WC_Gateway_PayJunction extends WC_Payment_Gateway {
		...
		function __construct() { 
			...
			//$this->icon 			= WP_PLUGIN_URL . "/" . plugin_basename( dirname(__FILE__)) . '/images/CardLogos.png';
